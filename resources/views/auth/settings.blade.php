                      ...
                      @csrf
                        <div class="col-6 form-group">
                          <input type="hidden" name="id" value="{{Auth::user()->id}}">
                            ...
                            <input type="email" name="email" class="form-control" id="exampleInputEmail1" value="{{Auth::user()->email}}" placeholder="Email">
                        </div>
                        <div class="col-6 form-group">
                          <label class="fw-bold" for="exampleInputEmail1">Nueva contraseña:</label>
                          <input type="password" name="password" class="form-control" id="exampleInputEmail1"  placeholder="Recuerde que entre más larga tiene mayor seguridad">
                        </div>
